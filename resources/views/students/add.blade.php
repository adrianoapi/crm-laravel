                ...
                <div class="span12">
                    <div class="box box-bordered box-color">
                        ...
                        <div class="box-content nopadding">
                            <form action="{{route('alunos.store')}}" method="POST" class='form-horizontal form-bordered'>
                            @csrf
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="cpf_cnpj" id="cpf_cnpj" placeholder="cpf ou cnpj" class="input-xlarge" required>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="responsavel" class="control-label">Responsável</label>
                                    <div class="controls">
                                        <input type="text" name="responsavel" id="responsavel" placeholder="Insira o nome do responsável" class="input-xlarge">
                                    </div>
                                </div>
